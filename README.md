...
&nbsp;&nbsp;&nbsp;&nbsp;For the results that there is no possible route, since there are obstacles forming a loop and isolating the start and end point, path cant not be formed. Althrough there are chances of no route can formed, the rate can be reduce by lower the amount of obstacle.
<br>
